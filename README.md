...
| 날짜       | 조원           | 시간   | 작업내용                                                                 |
|------------|----------------|--------|--------------------------------------------------------------------------|
| 25.06.19   | 팀원 모두      | 오전   | 아이디어 회의 및 역할 분담                                                  |
| 25.06.20   | 팀원 모두      | 오전   | 시스템 흐름 및 기능 정의, 부품 목록 및 기술 요소 정리                       |
| 25.06.23   | 팀원 모두      | 오전   | 시스템 흐름 및 기능 정의, 부품 목록 및 기술 요소 정리                       |
| 25.06.24   | 이화섭, 박해준 | 오전   | ROI 판정 기준 이해 및 개선, 중심점/면적비율 기반 수정                   |
|            |                | 오후   | ROI 겹침 비율(%) 기반 danger 알림 발생 코드 수정 및 테스트               |
| 25.06.23   | 이우석         | 오전   | (내용 없음)                                                              |
