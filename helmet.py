...
# 경로 설정
model_path = "/home/hwaseop/final/yolov5s_helmet3-20250626T011741Z-1-001/yolov5s_helmet3/weights/best.onnx"
class_names_file = "/home/hwaseop/final/classes.txt"
...
while True:
    ...
    for i in range(output.shape[1]):
        ...
        print(f"class_id: {class_id}, conf: {conf:.2f}, score: {score:.2f}, conf*score: {conf*score:.2f}, box: {box}")
